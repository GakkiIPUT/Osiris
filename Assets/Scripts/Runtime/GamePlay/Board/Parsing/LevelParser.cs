...
/// <summary>
/// ASCII レベル文字列から GridModel を構築するユーティリティ。
/// </summary>
public static class LevelParser
{
    ...
    {
        /// <summary>外周（Anchor/OuterWall）を自動生成するか</summary>
        public bool AutoGenerateOuterRings;

        /// <summary>最外周 Anchor 厚み</summary>
        public int AnchorThickness = 1;

        /// <summary>Anchor 内側の OuterWall 厚み</summary>
        public int OuterWallThickness = 1;

        /// <summary>ガード記号集合（Floor として扱い、別レイヤで生成）</summary>
        public HashSet<char> GuardSymbols = new(); // 例: { 'G','H','I',... }

        /// <summary>アイテム記号集合（Floor として扱い、別レイヤで生成）</summary>
        public HashSet<char> ItemSymbols = new();  // 例: { 'i','t','d','e',... }
    }

    /// <summary>
    /// 行配列から GridModel を生成する。
    /// </summary>
